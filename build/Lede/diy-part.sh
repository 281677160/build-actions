...
# 后台IP设置
export Ipv4_ipaddr="172.17.10.254"            # 修改openwrt后台地址(填0为关闭)
...
version.buildinfo
profiles.json
openwrt-xiaomi-redmi-router-ax6000-generic-kernel.bin
openwrt-xiaomi-redmi-router-ax6000-generic.manifest
openwrt-xiaomi-redmi-router-ax6000-generic-squashfs-rootfs.img.gz
EOF
