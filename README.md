...
#
- 6、`修改后台登录IP，在build文件夹-->对应您在第4步修改的源码文件夹里点开[diy-part.sh]，然后修改后台登录IP`《[修改ip教程](https://github.com/danshui-git/shuoming/blob/master/ip.md)》
#
- 7、`开启或者关闭某功能，在build文件夹-->对应您在第4步修改的源码文件夹里点开[settings.ini]，然后按需控制各项目开关`《[各开关控制教程](https://github.com/danshui-git/shuoming/blob/master/kaiguan.md)》
#
