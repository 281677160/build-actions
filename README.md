...
#
- 8、第4、5、6、7步骤都完成后，如果您在第 7 步骤没设置密匙没开启.config有变化就自动触发编译或者是本地获取的配置文件的话，就手动启动编译《[[启动教程](https://github.com/danshui-git/shuoming/blob/master/%E6%89%8B%E5%8A%A8%E5%BC%80%E5%A7%8B.md)]》
#
