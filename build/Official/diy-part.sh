...
# 后台IP设置
export Ipv4_ipaddr="172.16.10.254"            # 修改openwrt后台地址(填0为关闭)
...
version.buildinfo
profiles.json
openwrt-nanopi-r5s-generic-kernel.bin
openwrt-nanopi-r5s-generic.manifest
openwrt-nanopi-r5s-generic-squashfs-rootfs.img.gz
EOF
