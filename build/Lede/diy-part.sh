...
# 后台IP设置
export Ipv4_ipaddr="192.168.100.200"            # 修改openwrt后台地址(填0为关闭)
...
export DNS_Settings="192.168.100.1 223.5.5.5 114.114.114.114 8.8.8.8"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
