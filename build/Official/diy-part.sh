...
# 后台IP设置
export Ipv4_ipaddr="192.168.1.1"            # 修改openwrt后台地址如192.168.1.1(填0为关闭)
export Netmask_netm="255.255.255.0"           # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="HiWifi HC5962"                # 修改主机名称如为OpenWrt-123(填0为不作修改)
...
export Default_theme="0"                # 多主题时,选择某主题为默认第一主题 (填写主题名称如argon,填0为不作修改)
