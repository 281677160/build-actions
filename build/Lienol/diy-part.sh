...
# 默认主题设置
export Mandatory_theme="bootstrap-mod"      # 将默认必选主题由bootstrap替换为(如argon,源码要带此主题就行,填写名称也要写对，填0为不作修改)
...
export Customized_Information="我见青山多妩媚，料青山见我应如是"       # 个性签名,你想写啥就写啥，(填0为不作修改)
