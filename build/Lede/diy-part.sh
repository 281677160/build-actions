...
export Op_name="password"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
version.buildinfo
profiles.json
openwrt-nanop-r5s-generic-kernel.bin
openwrt-nanop-r5s-generic.manifest
openwrt-nanop-r5s-generic-squashfs-rootfs.img.gz
EOF
